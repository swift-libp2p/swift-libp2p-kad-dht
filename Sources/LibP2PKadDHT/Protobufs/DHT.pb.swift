...
// Source: Sources/LibP2PKadDHT/Protobufs/DHT.proto
//
...
enum DHT {
    ...
    struct Message: Sendable {
        ...
        enum MessageType: SwiftProtobuf.Enum, Swift.CaseIterable {
            ...
            static let allCases: [Message.MessageType] = [
                .putValue,
                .getValue,
                .addProvider,
                .getProviders,
        ...
        enum ConnectionType: SwiftProtobuf.Enum, Swift.CaseIterable {
            typealias RawValue = Int
            ...
            // The compiler won't synthesize support with the UNRECOGNIZED case.
            static let allCases: [Message.ConnectionType] = [
                .notConnected,
                .connected,
                .canConnect,
                .cannotConnect,
...
extension DHT.Message.MessageType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0PUT_VALUE\0\u{1}GET_VALUE\0\u{1}ADD_PROVIDER\0\u{1}GET_PROVIDERS\0\u{1}FIND_NODE\0\u{1}PING\0")
}

extension DHT.Message.ConnectionType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NOT_CONNECTED\0\u{1}CONNECTED\0\u{1}CAN_CONNECT\0\u{1}CANNOT_CONNECT\0")
}
...
extension DHT.Message.Peer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}addrs\0\u{1}connection\0")
