...
//    public func insert(_ peer:Peer.PeerInfo) -> EventLoopFuture<Bool> {
//        self.eventLoop.submit { self._insert(peer) }
//    }
...
//    public func insertMany(_ peers:[Peer.PeerInfo]) -> EventLoopFuture<[Bool]> {
...
//    @discardableResult
//    func remove(_ ma:Multiaddr) -> Bool {
//        for i in (0..<self.slots.count) {
//            if self.slots[i].peer.addresses.contains(ma) {
//                self.slots.remove(at: i)
//                return true
//            }
//        }
//        return false
...
//    public func remove(_ peerID:PeerID) -> EventLoopFuture<Bool> {
//        self.eventLoop.submit {
//            self._remove(peerID)
//        }
//    }
...
//    public func next() -> EventLoopFuture<Peer.PeerInfo?> {
//        self.eventLoop.submit {
//            self._next()
//        }
//    }
...
//    public func all() -> EventLoopFuture<[Peer.PeerInfo]> {
//        self.eventLoop.submit {
//            self._all()
//        }
//    }
