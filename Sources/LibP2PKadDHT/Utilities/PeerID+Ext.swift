...
extension PeerID {
    ...
    internal static func compareDistances(from: PeerID, to key1: PeerID, and key2: PeerID, using keyspace: KadDHT.Key.KeySpace = .xor) -> KadDHT.Key.ComparativeDistance {
    ...
    internal func compareDistancesFromSelf(to key1: PeerID, and key2: PeerID, using keyspace: KadDHT.Key.KeySpace = .xor) -> KadDHT.Key.ComparativeDistance {
